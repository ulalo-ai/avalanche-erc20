...
contract UlaloTokenFaucet is IUlaloFaucet {
    ...
    function withdraw(address to, uint256 amount) external override {
        require(amount < 50000 ether, "Amount exceeds limit");
        require(totalSent + amount <= faucetLimit, "Faucet limit reached");
    ...
    receive() external payable {
        require(msg.sender == manager || msg.sender == owner, "Only manager or owner can send ETH");
    }
}
